...
\begin{frame}{Funcionamiento}
	...
	\begin{enumerate}
		\item Se calcula la distancia entre el centro de masa del nodo y el cuerpo. \pause
		\item Si la distancia es lo suficientemente grande, los cuerpos contenidos en el nodo se toman como un solo cuerpo. \pause
...
\begin{frame}{Funcionamiento}
	...
	Donde $s$ corresponde con la longitud de la caja, y $d$ con la distancia. \pause
